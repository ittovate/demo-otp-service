...
public class OtpController {
  ...
  @Operation(
      ...
      description =
          "Generates and sends a One-Time Password (OTP) to the phone number"
            ...
            content =
                @Content(
                    ...
                    examples =
                        @ExampleObject(
                            value =
                                "{\"body\": null, \"statusCode\": 201, \"message\": \"Otp sent successfully!\"}"))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
            ...
            content =
                @Content(
                    ...
                    examples =
                        @ExampleObject(
                            value =
                                "{\"body\": null, \"statusCode\": 400, \"message\": \"Validation Error\"}"))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "500",
            ...
            content =
                @Content(
                    ...
                    examples =
                        @ExampleObject(
                            value =
                                "{\"body\": null, \"statusCode\": 500, \"message\": \"Internal server error\"}")))
      })
  @PostMapping
  ...
  @Operation(
      ...
      requestBody =
          @io.swagger.v3.oas.annotations.parameters.RequestBody(
              required = true,
              description =
                  "Phone number must be a valid phone number . Token must be a valid numerical 6-digit phone number"),
      responses = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
            ...
            content =
                @Content(
                    ...
                    examples =
                        @ExampleObject(
                            value =
                                "{\"body\": null, \"status\": 200, \"message\": \"Token verified successfully!\"}"))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
  ...
  public ResponseEntity<ApiResponse<String>> verify(
      @RequestBody @Valid VerifyOtpRequestDto verifyOtpRequestDto) throws BadRequestException {
